...
class BaseDriver(six.with_metaclass(abc.ABCMeta, object)):
  ...
  def run(self, input_dict: Dict[Text, List[types.Artifact]],
    ...
    Returns:
      An DriverOutput instance. Please note that the order of artifacts in the
      value of output_artifacts is expected to be the same as the order of
      the value of output_dict.
    """
    pass
