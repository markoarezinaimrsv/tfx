...
class FakeExampleGenLikeDriver(base_driver.BaseDriver):

  def __init__(self, mlmd_connection: metadata.Metadata,
               pipeline_info: pipeline_pb2.PipelineInfo,
               pipeline_node: pipeline_pb2.PipelineNode):
    super(FakeExampleGenLikeDriver, self).__init__(mlmd_connection,
...
class LauncherTest(test_utils.TfxTest):
  ...
  def setUp(self):
    ...
    self._custom_driver_spec.class_path = 'tfx.orchestration.portable.launcher_test.FakeExampleGenLikeDriver'
  ...
  def testLauncher_with_CustomDriver_NewSpan(self):
    ...
    with self._mlmd_connection as m:
      ...
      print("I'm here artifact: ", artifact)
      self.assertProtoPartiallyEquals(
          """
          id: 1
          type_id: 5
